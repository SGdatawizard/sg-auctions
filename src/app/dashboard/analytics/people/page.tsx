  ...
  return (
    <div className="space-y-8">
      <div>
        ...
        <p className="text-[#6687bc] text-sm mt-1">Top 10 buyers and vendors filtered by category and year</p>
      </div>
      ...
      <div className="card p-0 overflow-hidden">
        <div className="px-6 py-4 border-b border-[#1e3a6b]">
          <h2 className="section-title">
            ...
            {yearFilter !== "all" && (<span className="ml-2 badge badge-green">{yearFilter}</span>)}
          </h2>
        </div>
        {loading ? (
          ...
          <div className="text-center py-16">
            ...
            <p className="text-[#6687bc] text-sm">No {activeTab} data for this selection</p>
          </div>
        ) : (
            ...
            <table className="w-full">
              ...
              <tbody>
                {activeData.map((person, i) => (
                  <tr key={person.id} className="border-b border-[#1e3a6b]/50 hover:bg-[#1e3a6b]/30 transition-colors">
                    <td className="table-cell px-6">
                      <span className={`inline-flex items-center justify-center w-6 h-6 rounded-full text-xs font-bold ${i === 0 ? "bg-gold-500 text-[#0e1e38]" : i === 1 ? "bg-[#94aed6] text-[#0e1e38]" : i === 2 ? "bg-[#c99a0f]/50 text-gold-300" : "bg-[#1e3a6b] text-[#6687bc]"}`}>
                        {i + 1}
                      </span>
                    </td>
